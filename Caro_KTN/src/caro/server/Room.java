...
public class Room implements Serializable{
        ...
        if (client == client1)
        {
            ...
            if (Find5Block(CPiece.BLACK, gPos.x, gPos.y)==OK5)
            {
                ...
                if (competition!=null)
                {
                    ...
                    client1.SendMessage(75, null);
                    competition.removeClient(client2);
                    competition.removeRoom(this);
                    return 1;
                }
            }
            else
        ...
        else
        {
            ...
            if (Find5Block(CPiece.WHITE, gPos.x, gPos.y)==OK5)
            {
                ...
                if (competition!=null)
                {
                    ...
                    client2.SendMessage(75, null);
                    competition.removeClient(client1);
                    competition.removeRoom(this);
                    return 1;
                }
            }
    ...
    public Boolean add(ClientHandler client) throws IOException
    {
        ...
        if (client2==null)
        {
            ...
            arrUser[0] = client1.user;
            arrUser[1] = client2.user;
            client1.SendMessage(34, arrUser);
            return true;
        }
        return false;
    }
    ...
    {
        Boolean flag = true;
        for (ClientHandler cli : lstClientView) {
        ...
        if (!flag) {
            lstClientView.remove(clientHandler);
            clientHandler.room = null;
        } else {
            if (countAvailable() == 1) {
                if (client1 != null) {
                    client1.room = null;
